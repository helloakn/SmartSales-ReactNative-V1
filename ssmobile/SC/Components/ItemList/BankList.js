       ...
       // navigation = this.props.navigation;
        ...
        for(let index=0;index<items.length;index++){
            data.push(
                 ...
                 <BtnTop style={(this.props.selectedItem==items[index].id?styles.boxShadowUpHightLight:styles.boxShadowUp)}></BtnTop>
                    <BtnDown style={(this.props.selectedItem==items[index].id?styles.boxShadowDownHightLight:styles.boxShadowDown)}>
                        <Brcontainer>
                        {(items[index].image!=''?
                        <Image  style={{ 
                            width: '70%', height: '70%',
                        ...
                        <Image  style={styles.image} source={img} />
                            ...
                            <Text style={{color:'#767D87',fontSize:16,fontWeight:'bold'}}>{items[index].name}</Text>
                        </Brcontainer>
                    </BtnDown>
                    </TouchableOpacity>
                </BtnContainer>
