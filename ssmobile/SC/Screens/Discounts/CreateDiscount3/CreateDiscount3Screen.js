...
export default class CreateDiscount3Screen extends ScreenController {
                ...
                <Container>
                    ...
                    <Body>
                        ...
                        <Row>
                            ...
                            <TextInput placeholder="%" style = {styles.textinput} editable onChangeText={text => this.onDiscountPercentageChangeText(text)}
