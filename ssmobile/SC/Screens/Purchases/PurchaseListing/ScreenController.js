...
export class ScreenController extends Component{
    ...
    onCreate=()=>{
        this.props.navigation.navigate('CreatePurchaseScreen',{
            Title:"CreatePurchaseScreen",
...
// alert('y');
        ...
        */
        ...
        fetch("https://focusbeauty.zotefamily.com/v1/PurchaseOrder/GetList",{
            method: 'POST',
            headers: {
                Accept: 'text/plain',
        ...
        .then(
            (returnData) => {
                ...
                if(status==200){
                    ...
                    console.log(returnData.data[0].data_list);
                    console.log('still no error');
                    var data = this.state.data;
                    if(this.state.page!=1){
                        data = data.concat(returnData.data[0].data_list);
                    }
                    else{
                        data = returnData.data[0].data_list;
                    }
                    console.log('this is data');
                    console.log(data);
                    console.log('end this is data');
